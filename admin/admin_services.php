	...
	<div class="container py-lg-5 py-3">
		...
		<div class="row service-grids">
			<div class="col-lg-4 col-md-6 service-grid1">
				<a href="../application_form.php"><h3>CoralBeauty Hostel</h3></a>
				<div class="row">
					...
					<div class="col-lg-3 col-sm-6 banner_bottom_right_grid">
						<div class="view view-tenth">
							<div class="agile_text_box">
								...
								<h3> Apply for CoralBeauty Hostel</h3>
								<p></p>
							</div>
							<div class="mask">
                  ...
                  <span class="popuptext" id="myPopup">Admin cannot apply for a hostel !</span>
					...
					<div class="col-lg-3 col-sm-6 mt-sm-0 mt-3 banner_bottom_right_grid">
						<div class="view view1 view-tenth">
							<div class="agile_text_box">
								<i class="fas fa-bed" aria-hidden="true"></i>
								<h3>Apply for Silvertips-Hostel</h3>
								<p></p>
							</div>
							<div class="mask">
					...
					<div class="col-lg-3 col-sm-6 mt-lg-0 mt-3 banner_bottom_right_grid">
						<div class="view view2 view-tenth">
							<div class="agile_text_box">
								<i class="fas fa-bed" aria-hidden="true"></i>
								<h3>Apply for Knuckles-Hostel</h3>
								<p></p>
							</div>
							<div class="mask">
					...
					<div class="col-lg-3 col-sm-6 mt-lg-0 mt-3 banner_bottom_right_grid">
						<div class="view view3 view-tenth">
							<div class="agile_text_box">
								<i class="fas fa-bed" aria-hidden="true"></i>
								<h3>Apply for Udawala-Hostel</h3>
								<p></p>
							</div>
							<div class="mask">
				...
				<div class="row wthree_banner_bottom_right_grids pr-sm-3">
					...
					<div class="col-lg-3 col-sm-6 mt-lg-0 mt-3 banner_bottom_right_grid">
						<div class="view view2 view-tenth">
							<div class="agile_text_box">
								<i class="fas fa-bed" aria-hidden="true"></i>
								<h3>Apply for Hanthana-Hostel </h3>
								<p></p>
							</div>
							<div class="mask">
								<img src="../web_home/images/s3.jpg" class="img-responsive" alt="" />
	...
	<div class="container py-md-5">
		...
		<div class="footer-grid">
			...
			<div class="agileits_w3layouts-copyright mt-4 text-center">
				<p>© 2022 Intrend. All Rights Reserved.<a href="http://w3layouts.com/" target="=_blank"> </a></p>
		</div>
		</div>
	</div>
</footer>
